...
def recombine_stems(original_input : str, input_vocal_stem : str, input_instrumental_stem : str):
...
if __name__ == '__main__':
    ...
    reassembled_vocals = recombine_segments(input_filename, vocal_segments)
    files_to_clean.append(reassembled_vocals)
    recombined = recombine_stems(input_filename, reassembled_vocals, intrumental_stem)
